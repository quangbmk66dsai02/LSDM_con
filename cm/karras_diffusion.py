...
class KarrasDenoiser:
    ...
    def consistency_losses(
        ...
        mask, given_objs, given_cats, target_obj, target_cat, y = x_start
        # print("this is mask", mask)
        # print("this is go ", given_objs)
        # print("this is gc", given_cats)
        # print("this is to", target_obj)
        # print("this is tc", target_cat)
        # print("this is y", y)
        ...
        indices = th.randint(
            0, num_scales - 1, (target_obj.shape[0],), device=target_obj.device
        )
        ...
        x_t = target_obj + noise * append_dims(t, dims)

        dropout_state = th.get_rng_state()
        distiller = denoise_fn(x = x_t, mask = mask, given_objs=given_objs, given_cats = given_cats, y = y, t=t)
        print("done distiller")
        if teacher_model is None:
            x_t2 = euler_solver(x_t, t, t2, target_obj).detach()
        else:
            x_t2 = heun_solver(x_t, t, t2, target_obj).detach()
